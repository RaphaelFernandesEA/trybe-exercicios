...
function maisRepetido(array) {
  ...
  for (let index in array) {
    let numeroAVerificar = array[index]
    for (let index2 in array) {
      if(numeroAVerificar === array[index2]){
        repeticoes += 1
      }
    }
    if(repeticoes > maisRepetido) {
      maisRepetido = repeticoes;
      indexMaisRepetido = array[index];
    }
    repeticoes = 0;
  }
...
// 7 - Crie uma função que receba um número natural (número inteiro não negativo) N e retorne o somatório de todos os números de 1 até N.
// Valor de teste: N = 5.
