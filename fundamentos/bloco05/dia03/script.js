...
let ulDays = document.querySelector('#days');
    function calendarDays (dezDaysList) {
...
function changeHolidayColor (event) {
    ...
    for (let index = 0; index < holidayDays.length; index += 1) {
        let markedDays = holidayDays[index];
        if(markedDays.style.backgroundColor === 'red') {
            markedDays.style.backgroundColor = 'rgb(238,238,238)'
        } else {
            markedDays.style.backgroundColor = 'red'
        }
    }
}
